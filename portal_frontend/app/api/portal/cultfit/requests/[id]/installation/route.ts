...
import { fetchCustomerInstallationView, LeadNotFoundError, PartnerNotMappedError, type Authz } from '@/lib/odoo-server';
...
export async function GET(
  ...
  try {
    ...
    const view = await fetchCustomerInstallationView(requestId, authz);
    ...
    console.error('[customer installation view]', e instanceof Error ? e.message : e);
